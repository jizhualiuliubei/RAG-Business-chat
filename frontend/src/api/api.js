...
// ============ RAG 评测 ============
export const getEvaluationCatalog = () => http.get('/evaluations/catalog')
export const getEvaluationMetricsDefinition = () => http.get('/evaluations/metrics-definition')
export const runEvaluation = (payload) => http.post('/evaluations/run', payload)
...
export const generateEvaluationDataset = (payload) => http.post('/evaluation-datasets/generate', payload)
